...
localStorage.setItem("mensDataa", JSON.stringify(MensData));

var allMenDeta = JSON.parse(localStorage.getItem("mensDataa")) || []

function displayDataMen(allMenDeta) {
    document.querySelector("#products").innerHTML = ""
    allMenDeta.map(function (elem) {
        ...
        maindiv.append(image, btn, name, tags, priceDiv)
